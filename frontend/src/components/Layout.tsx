...
const menuItemsMap: Record<string, MenuItemConfig> = {
  ...
  users: { id: 'users', label: 'Users', icon: <PeopleIcon />, path: '/role/superAdmin/userManagement' },
  roles: { id: 'roles', label: 'Roles', icon: <RolesIcon />, path: '/role/admin/rolePermissions' },
  permissions: { id: 'permissions', label: 'Permissions', icon: <PermissionsIcon />, path: '/role/admin/rolePermissions' },
  ...
  analytics: { id: 'analytics', label: 'Analytics', icon: <AnalyticsIcon />, path: '/reports' },
  ...
  team: { id: 'team', label: 'Team Management', icon: <TeamIcon />, path: '/role/divisionManager/teamManagement' },
  tasks: { id: 'tasks', label: 'Tasks', icon: <TasksIcon />, path: '/role/divisionManager/budgetTracking' },
  opportunities: { id: 'opportunities', label: 'Opportunities', icon: <OpportunitiesIcon />, path: '/role/volunteer/opportunities' },
  my_hours: { id: 'my_hours', label: 'My Hours', icon: <HoursIcon />, path: '/role/volunteer/opportunities' },
  certificates: { id: 'certificates', label: 'Certificates', icon: <CertificateIcon />, path: '/certificates' },
  community: { id: 'community', label: 'Community', icon: <CommunityIcon />, path: '/events' },
  my_profile: { id: 'my_profile', label: 'My Profile', icon: <PersonIcon />, path: '/settings' },
  feedback: { id: 'feedback', label: 'Feedback', icon: <FeedbackIcon />, path: '/feedback' },
  my_talks: { id: 'my_talks', label: 'My Talks', icon: <SpeakerIcon />, path: '/role/speaker/myEngagements' },
  audience_analytics: { id: 'audience_analytics', label: 'Audience Analytics', icon: <AnalyticsIcon />, path: '/reports' },
  profile: { id: 'profile', label: 'Profile', icon: <PersonIcon />, path: '/settings' },
  my_sponsorships: { id: 'my_sponsorships', label: 'My Sponsorships', icon: <SponsorshipIcon />, path: '/role/sponsor/sponsorships' },
  tickets: { id: 'tickets', label: 'Tickets', icon: <TicketsIcon />, path: '/role/customerSupport/ticketManagement' },
  knowledge_base: { id: 'knowledge_base', label: 'Knowledge Base', icon: <KnowledgeBaseIcon />, path: '/reports' },
};
